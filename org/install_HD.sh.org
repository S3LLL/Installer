...
declare -r DISQUE=$(cat /var/lib/installFrogLinux/periph_HD.list | cut -d, -f2)
declare -r TAILLE_DISQUE=$(cat /var/lib/installFrogLinux/periph_HD.list | cut -d' ' -f1 | cut -d, -f3)
